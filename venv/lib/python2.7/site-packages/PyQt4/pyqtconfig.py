...
_pkg_config = {
    'pyqt_bin_dir':      '/usr/local/Cellar/pyqt/4.11.1/bin',
    'pyqt_config_args':  '--confirm-license --bindir=/usr/local/Cellar/pyqt/4.11.1/bin --destdir=/usr/local/Cellar/pyqt/4.11.1/lib/python2.7/site-packages --sipdir=/usr/local/share/sip',
    'pyqt_mod_dir':      '/usr/local/Cellar/pyqt/4.11.1/lib/python2.7/site-packages/PyQt4',
    ...
    'qt_archdata_dir':   '/usr/local/Cellar/qt/4.8.6',
    'qt_data_dir':       '/usr/local/Cellar/qt/4.8.6',
    'qt_dir':            '/usr/local/Cellar/qt/4.8.6',
    'qt_edition':        'free',
    'qt_framework':      1,
    'qt_inc_dir':        '/usr/local/Cellar/qt/4.8.6/include',
    'qt_lib_dir':        '/usr/local/Cellar/qt/4.8.6/lib',
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                '/usr/local/Cellar/qt/4.8.6/lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    'LIBS_CORE':                '',
