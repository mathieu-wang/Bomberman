...
_pkg_config = {
    ...
    'pyqt_config_args':  '--confirm-license --verbose -q /usr/bin/qmake-qt4 -c -j 10 LIBDIR_QT=/usr/lib STRIP= MOC=moc-qt4 LIBS_OPENGL= LIBS_X11= LIBS_THREAD= LFLAGS= CXXFLAGS_RELEASE=-g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Os LFLAGS_RELEASE=-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-O1 -m /usr/lib/python2.7/config -d /usr/lib/python2.7/dist-packages --dbus /usr/include/dbus-1.0',
    'pyqt_mod_dir':      '/usr/lib/python2.7/dist-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtNetwork QtDBus QtDeclarative QtOpenGL QtScript QtScriptTools QtSql QtSvg QtTest QtWebKit QtXml QtXmlPatterns phonon QtAssistant QtDesigner',
...
_default_macros = {
    ...
    'CXXFLAGS_MT_DLL':          '',
    'CXXFLAGS_MT_DLLDBG':       '',
    'CXXFLAGS_RELEASE':         '-g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Wformat-security -Os',
    'CXXFLAGS_RTTI_OFF':        '',
    'CXXFLAGS_RTTI_ON':         '',
    'CXXFLAGS_SHLIB':           '-fPIC',
    'CXXFLAGS_STL_OFF':         '',
    ...
    'LFLAGS_RELEASE':           '-Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-O1',
